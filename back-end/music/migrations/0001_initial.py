    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(default=datetime.date(2021, 5, 13))),
                ('artist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='albums', to=settings.AUTH_USER_MODEL)),
                ('fans', models.ManyToManyField(related_name='fav_albums', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Song',
            fields=[
                ...
                ('fans', models.ManyToManyField(related_name='fav_songs', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
