...
urlpatterns = [
    ...
    path('users/<int:id>/albums/fav/<int:album_id>', views.UserFavAlbumDel.as_view(), name='user-fav-album-del'),
    ...
    path('users/<int:id>/tracks/fav/<int:track_id>', views.UserFavTrackDel.as_view(), name='user-fav-track-del'),
    ...
    path('tracks/<int:id>/kinds/<int:kind_id>', views.TrackKindsDelete.as_view(), name='track-kinds-delete'),
